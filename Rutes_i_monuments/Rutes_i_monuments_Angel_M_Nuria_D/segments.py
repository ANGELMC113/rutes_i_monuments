...
def download_segments(box: Box, filename: str, maxpage: int = -1, feedback: bool = DEFAULT_FEEDBACK) -> None:
...
def get_segments(box: Box, filename: str, maxpage: int = -1, feedback: bool = DEFAULT_FEEDBACK) -> Segments:
