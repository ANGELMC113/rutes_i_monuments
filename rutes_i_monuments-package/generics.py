...
MONUMENTS_FILENAME = "./data/monuments.dat"  # Changing this filename can cause problems if the new filename (or METADATA_MONUMENTS_FILENAME) already exists
...
class Box:
    ...
    def get_str_format(self) -> str:
        ...
        The string consists on all the coordinates separated by commas.
